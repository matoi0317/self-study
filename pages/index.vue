<template>
  <div>
    ...
    <div class="join">
      <a href="https://us02web.zoom.us/j/83408884871?pwd=NDg3aEhaY0tCb2gyMnRPTWZORHNXZz09" class="button is-primary is-fullwidth">
        ガリ勉自習室に参加する
      </a>
    ...
    <div class="rules">
      <ul>
        ...
        <div class="d"><li><font color="red">・自習室の様子をYouTubeにてLive配信しています</font></li></div>
        ...
        <li>・<font color="red">休憩時間のチャットは禁止です</font></li>
        <li>・プログラミングでも参加可能！</li>
        <li>・何歳でも参加可能なので、みんなで勉強しましょう！</li>
      </ul>
    </div>
    <div class="download">
